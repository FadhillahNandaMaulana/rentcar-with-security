              ...
              <form action="car-listing.php" method="get">
                ...
                <div class="form-group select">
                  <select class="form-control" name="fueltype" required>
                    ...
                    <option value="Petrol" <?php if (strcasecmp($fueltype, "Petrol") == 0) echo "selected"; ?>>Petrol</option>
                    <option value="Diesel" <?php if (strcasecmp($fueltype, "Diesel") == 0) echo "selected"; ?>>Diesel</option>
                    <option value="CNG" <?php if (strcasecmp($fueltype, "CNG") == 0) echo "selected"; ?>>CNG</option>
                  </select>
                </div>
