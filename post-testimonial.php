        ...
        <div class="container">
          <div class="page-header_wrap">
            <div class="page-heading">
              <h1>Posting Testimoni</h1>
            </div>
            <ul class="coustom-breadcrumb">
              <li><a href="#">Beranda</a></li>
              <li>Posting Testimoni</li>
            </ul>
          </div>
        </div>
        <!-- Dark Overlay-->
...
?>
                ...
                <div class="profile_wrap">
                  <h5 class="uppercase underline text-center">Posting Testimoni</h5>
                  <?php if ($error) { ?>
                  ...
                  <form method="post">
                    ...
                    <div class="form-group">
                      <button type="submit" name="submit" class="btn">Simpan <span class="angle_arrow"><i
