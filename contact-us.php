...
if (isset($_POST['send'])) {
  ...
  // Menggunakan prepared statement dan bindParam agar aman dari SQL Injection
  ...
  if ($query->execute()) {
    $msg = "Pertanyaan Terkirim. Kami akan menghubungi Anda segera";
  } else {
...
<html lang="id">
  ...
  <body>
    ...
    <!--Page Header-->
    <section class="page-header contactus_page" style="background-image: url('assets/images/banner/banner5.jpg'); padding: 10px 0;>
      <div class="container">
    ...
    <!--Contact-us-->
    <section class="contact_us section-padding" style="background-color: rgb(198, 198, 198)">
      <div class="container" >
        <div class="row">
          <div class="col-md-6">
            <h3>Hubungi kami menggunakan formulir di bawah ini</h3>
            <?php if ($error) { ?>
              <div class="errorWrap"><strong>GALAT</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?>
                <div class="succWrap"><strong>SUKSES</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
            <div class="contact_form" style="background-color:rgb(198, 198, 198)">
              <form method="post">
                ...
                <div class="form-group">
                  <button class="btn" type="submit" name="send" type="submit">Kirim Pesan <span
