...
></p>
                ...
                <div class="profile_wrap" >
                  <h5 class="uppercase underline text-center">Testimoni Saya </h5>
                  <div class="my_vehicles_list" style="background-color: #ffffff">
                      ...
                      if (count($results) > 0) {
                        foreach ($results as $result) { ?>
                          ...
                          <li>
                            ...
                            <?php } else { ?>
                              <div class="vehicle_status" > <a href="#" class="btn outline btn-xs">Menunggu Persetujuan</a>
                                <div class="clearfix"></div>
                              </div>
                            <?php } ?>
                          </li>
