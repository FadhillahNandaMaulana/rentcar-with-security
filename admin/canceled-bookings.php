			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Batalkan Pemesanan</h2>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php 
$status = 2;
$sql = "SELECT tblusers.FullName, tblbrands.BrandName, tblvehicles.VehiclesTitle, tblbooking.FromDate, tblbooking.ToDate, tblbooking.message, 
...
?>
										<tr>
											...
											<td><a href="edit-vehicle.php?id=<?php echo $result->vid; ?>"><?php echo $result->BrandName; ?> , <?php echo $result->VehiclesTitle; ?></a></td>
											...
											<td><a href="booking-details.php?bid=<?php echo $result->id; ?>">Lihat</a></td>
										</tr>
									<?php 
											$cnt++;
										}
