...
// Menghilangkan validasi session (session check)
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Ubah Merek</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Ubah Merek</div>
...
<?php	
$id = intval($_GET['id']); // Pastikan hanya angka yang diambil
