...
if (isset($_POST['login'])) {
    ...
    $password = $_POST['password']; // plain text dari form login
...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <div class="login-page bk-img" style="background-image: url(img/avanza.jpg);" >
                        ...
                        <div class="col-md-6 col-md-offset-3"  >
                            ...
                            <div class="well row pt-2x pb-3x bk-light">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <p style="margin-top: 4%" align="center"><a href="../index.php">Kembali ke Beranda</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
