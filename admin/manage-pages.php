...
if ($_POST['submit'] == "Update") {
	...
	$query->bindParam(':detail', $pagedetails, PDO::PARAM_STR);
	$query->bindParam(':type', $pagetype, PDO::PARAM_STR);
	$query->execute();
												...
												<form method="post" name="chngpwd" class="form-horizontal"
														...
														<div class="col-sm-8">
															<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
																<option value="" selected="selected" class="form-control">
																	***Select One***</option>
																<option value="manage-pages.php?type=terms">syarat dan ketentuan pengguna</option>
																...
																<option value="manage-pages.php?type=faqs">persratayan umum</option>
															</select>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															...
															switch ($_GET['type']) {
																case "terms":
																	echo "Syarat dan Ketentuan Pengguna";
																	break;

																case "privacy":
																	echo "Kebijakan Privasi";
																	break;
													...
													<div class="form-group">
														...
														<div class="col-sm-8">
															<textarea class="form-control" rows="5" cols="50"
																...
																placeholder="Package Details" required><?php
																$pagetype = $_GET['type'];
													...
													<div class="form-group">
														<div class="col-sm-8 col-sm-offset-4">
															...
															<button type="submit" name="submit" value="Update" id="submit"
																class="btn-primary btn">Ubah</button>
														</div>
													</div>
